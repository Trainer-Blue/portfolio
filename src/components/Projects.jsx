  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center py-16 px-8 md:px-12 lg:px-16 text-white">
      <div className="max-w-5xl w-full backdrop-blur-[2px] bg-transparent rounded-2xl p-10 md:p-16 shadow-xl">
        <h2 className="text-4xl md:text-5xl font-bold text-center gradient-text leading-relaxed">My Projects</h2>
        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="grid md:grid-cols-2 gap-10 mb-20">
            ...
            <div className="flex flex-col space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="pt-4">
                  <a 
                    href="https://lexispdf.vercel.app" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-4 py-2 bg-purple-700 hover:bg-purple-600 rounded-lg transition-colors duration-300"
                  >
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div className="flex flex-col items-center justify-center">
              <div className="rounded-lg overflow-hidden border-2 border-purple-500 shadow-lg mb-6 w-full">
                <img src="/samvedna-screenshot.png" alt="Samvedna Landing Page" className="w-full h-auto object-cover" />
              </div>
            </div>
            
            {/* Right column - Project details */}
            <div className="flex flex-col space-y-6">
              <h3 className="text-2xl font-semibold text-purple-300">Samvedna - Mental Health & Neuropsychological Services Landing Page</h3>
              
              <div className="space-y-4">
                <p className="text-lg leading-relaxed">
                  A responsive and accessible landing page for a real-world neuropsychological rehabilitation center, optimized for cross-device user experience with clean UI/UX structure and dynamic service sections.
                </p>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <span className="px-3 py-1 bg-purple-900 bg-opacity-50 rounded-full text-sm">TypeScript</span>
                    <span className="px-3 py-1 bg-purple-900 bg-opacity-50 rounded-full text-sm">Tailwind CSS</span>
                    <span className="px-3 py-1 bg-purple-900 bg-opacity-50 rounded-full text-sm">EmailJS</span>
                    <span className="px-3 py-1 bg-purple-900 bg-opacity-50 rounded-full text-sm">SVG</span>
                    <span className="px-3 py-1 bg-purple-900 bg-opacity-50 rounded-full text-sm">Vercel Hosting</span>
                  </div>
                </div>
                
                <div className="pt-4">
                  <a 
                    href="https://samvedna.vercel.app" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-4 py-2 bg-purple-700 hover:bg-purple-600 rounded-lg transition-colors duration-300"
                  >
