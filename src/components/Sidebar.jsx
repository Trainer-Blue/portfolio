...
const Sidebar = () => {
  ...
  useEffect(() => {
    // Set mounted state after a tiny delay to trigger animations
    setTimeout(() => {
      setMounted(true);
    }, 300);
    ...
    <div>
      ...
      <nav className={mounted ? 'nav-visible' : 'nav-hidden'}>
        <a 
          ...
          className={`nav-item-1 ${activeNav === '#hero' ? 'active' : ''}`}
        >
          <Typography>
            Home
          </Typography>
        ...
        <a 
          ...
          className={`nav-item-2 ${activeNav === '#about' ? 'active' : ''}`}
        >
          <Typography>
            About
          </Typography>
        ...
        <a 
          ...
          className={`nav-item-3 ${activeNav === '#projects' ? 'active' : ''}`}
        >
          <Typography>
            Projects
          </Typography>
        ...
        <a 
          ...
          className={`nav-item-4 ${activeNav === '#contact' ? 'active' : ''}`}
        >
          <Typography>
            Contact
          </Typography>
